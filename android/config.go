...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Ion.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.IonConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Ion.Specific_camera_parameter_library)
}
